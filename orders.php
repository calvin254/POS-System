							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-info view_order2" type="button" data-id="<?php echo $row['id'] ?>"><i class="fa fa-eye"></i></button>
									</td>
...
<script>
	...
	$('.view_order2').click(function(){
		uni_modal("Order  Details","view_order2.php?id="+$(this).attr('data-id'),"mid-large")
